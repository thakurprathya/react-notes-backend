...
async (req, res)=>{  //for post request send on endpoint /auth/createuser
    ...
    try{
        ...
        const authtoken= jwt.sign(data, process.env.SECRET);  //second parameter is a secret string it could be anything, sign is a synchronous funct so no need of async await
        success=true;
