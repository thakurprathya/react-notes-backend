...
const fetchuser= (req, res, next)=>{
    ...
    try{
        const data= jwt.verify(token, process.env.SECRET.toString());  //second parameter is our secret code also passed during login, idealy should be included as env variable
        req.user= data.user;
